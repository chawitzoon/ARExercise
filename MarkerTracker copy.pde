...
class MarkerTracker {
	...
	void findMarker(ArrayList<Marker> markers) {
        ...
        kNumOfCorners = 4;
        Scalar dot_color = new Scalar(0, 0, 255, 1); //(0,0,255,0.9) 0.9 is transparency
        println("new draw");
        ...
        for (int i = 0; i < contours.size(); i++) {
            ...
            double approxDistance = Imgproc.arcLength(contour2f, true) * 0.02; //epsilon - Parameter specifying the approximation accuracy. This is the maximum distance between the original curve and its approximation.
            
            println("for loop each contour");
